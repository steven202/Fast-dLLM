#!/bin/bash
# LLaDA-8B Baseline — from Fast-dLLM, n=200
...
mkdir -p $FD/evals_results_0502/llada8b_baseline
...
echo "=== LLaDA-8B Baseline (Fast-dLLM) ==="

for ds in "gsm8k 5 200" "humaneval 0 164" "minerva_math500 4 200" "mbpp 3 200"; do
  set -- $ds; task=$1; fs=$2; lim=$3; out=$FD/evals_results_0502/llada8b_baseline/${task}-s256-n200
