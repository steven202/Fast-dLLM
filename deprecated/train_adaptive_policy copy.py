...
def rollout_llada(
    ...
    while current_len < gen_length:
        ...
        entropy = torch.distributions.Categorical(logits=last_logits.float()).entropy()
...
def main():
    ...
    parser.add_argument("--ar_reward_model", type=str, default="Qwen/Qwen3-30B-A3B-Instruct-2507")
    ...
    parser.add_argument("--guidance_gamma", type=float, default=0)
