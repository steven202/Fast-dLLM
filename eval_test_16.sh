...
--model_args pretrained=${model_path},policy_path=${policy_path},gen_length=${length},steps=${steps},block_len_min=${block_len_min},block_len_max=${block_len_max},use_cache=True,dual_cache=True,threshold=0.9,threshold_impl=${threshold_impl},gumbel_temperature=0.0,show_speed=True,show_actions=True,wandb=True
